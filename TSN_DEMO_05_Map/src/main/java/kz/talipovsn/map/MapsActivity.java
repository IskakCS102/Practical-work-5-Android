...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.2839928, 76.9704304); // Начальный маркер
    static final LatLng marker1 = new LatLng(52.2496813, 76.987478); // Маркер Противотуберкулезный диспансер
    static final LatLng marker2 = new LatLng(52.2516766, 76.9667853); // Маркер КГП на ПХВ «Павлодарская областная детская больница»
    static final LatLng marker3 = new LatLng(52.286531, 76.9628766); // Маркер Мечети
    static final LatLng marker4 = new LatLng(52.266451, 76.9714418); // Маркер Казахский Музыкально-Драматический театр
    static final LatLng marker5 = new LatLng(52.2960934, 76.9278939); // Маркер Благовещенский собор
  ...
  //      mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.tuber)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker2).title((getString(R.string.marker2_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.oblasty)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.mechet)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker4).title((getString(R.string.marker4_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.music)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.sobor)).alpha(ALPHA).
